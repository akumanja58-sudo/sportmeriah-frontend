...
export async function generateMetadata({ params, searchParams }) {
    ...
    try {
        const res = await fetch(
            `https://sportmeriah-backend-production.up.railway.app/api/fixtures/${fixtureId}`,
        ...
        if (data.success && data.fixture) {
            ...
            return {
                ...
                description: `Nonton live streaming ${matchTitle} gratis di SportMeriah. Pertandingan ${league} dengan kualitas HD tanpa buffering. Saksikan sekarang!`,
                keywords: [
                    `streaming ${homeTeam}`,
                    `streaming ${awayTeam}`,
                ...
                openGraph: {
                    ...
                    description: `Nonton live streaming ${matchTitle} gratis. ${league} dengan kualitas HD!`,
                ...
                twitter: {
                    ...
                    description: `Nonton live streaming ${matchTitle} gratis di SportMeriah!`,
                    images: [fixture.teams?.home?.logo || '/og-image.png'],
                },
                alternates: {
    ...
    return {
        ...
        description: 'Nonton live streaming sepakbola gratis di SportMeriah dengan kualitas HD.',
    };
}

// ========== JSON-LD FOR SPORTS EVENT ==========
export function generateJsonLd(fixture) {
    if (!fixture) return null;

    const homeTeam = fixture.teams?.home?.name || 'Home';
    const awayTeam = fixture.teams?.away?.name || 'Away';
    const league = fixture.league?.name || 'Football';
    const startDate = fixture.date || new Date().toISOString();

    return {
        '@context': 'https://schema.org',
        '@type': 'SportsEvent',
        'name': `${homeTeam} vs ${awayTeam}`,
        'description': `Pertandingan ${league}: ${homeTeam} melawan ${awayTeam}`,
        'startDate': startDate,
        'endDate': startDate, // Will be updated when match ends
        'eventStatus': 'https://schema.org/EventScheduled',
        'eventAttendanceMode': 'https://schema.org/OnlineEventAttendanceMode',
        'location': {
            '@type': 'VirtualLocation',
            'url': `https://www.sportmeriah.com/match/${fixture.id}`
        },
        'organizer': {
            '@type': 'Organization',
            'name': league,
